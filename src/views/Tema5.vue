    ...
    AcordionA(tipo="a" clase-tarjeta="tarjeta tarjeta--gris")
      ...
      .row.justify-content-center(titulo="Nota 5: Efectivo y equivalentes al efectivo")
        ...
        .col-md
          ...
          .cajon.color-acento-contenido.p-4
            p.mb-0 Es necesario explorar las Normas Internacionales de Información Financiera para ampliar y fortalecer los conceptos y políticas establecidas para cada norma de acuerdo con el grupo de presentación de información financiera, a continuación, se encuentra el enlace de la NIC 1: 
